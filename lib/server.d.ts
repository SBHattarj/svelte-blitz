...
export declare const setupBlitzServer: (args_0: {
    plugins: import("blitz").BlitzServerPlugin<import("blitz").RequestMiddleware<import("http").IncomingMessage, import("http").ServerResponse<import("http").IncomingMessage>>, import("@blitzjs/next").Ctx, {}>[];
